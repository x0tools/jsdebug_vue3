<template>
    ...
    <el-main class="page-content">
        <MdPreview :editorId="id" :modelValue="mdtext" 
        theme="dark" 
        codeTheme="github" 
        previewTheme="default"/>
        <!-- <el-scrollbar class="container-body-scrollbar" height="100%">
             <v-md-preview ref="md_preview" preview-class="vuepress-markdown-body" class="md_" :text="mdtext"> </v-md-preview> 
        </el-scrollbar> -->
    </el-main>
</template>
<script>
